            ...
            <form method="POST">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-12">
                        ...
                        value="<?php echo $this->model->getCNPJ(); ?>">
                    </div>
                </div>
                <div class="form-group row mt-3">
                    ...
                    <div class="col-12">
                        ...
                        value="<?php echo $this->model->getEndereco(); ?>">
                    </div>
                </div>
                <div class="form-group row mt-3">
                    ...
                    <div class="col-12">
                        ...
                        value="<?php echo $this->model->getCidade(); ?>">
                    </div>
                ...
                <div class="form-group row mt-3">
                    <label class="col-12 col-form-label" for="uf">UF</label>
                        ...
                        value="<?php echo $this->model->getUf(); ?>">
                        </div>
                </div>
                <div class="form-group row mt-3">
                    <label class="col-12 col-form-label" for="cep">CEP</label>
                        ...
                        value="<?php echo $this->model->getCep(); ?>">
                        </div>
                </div>
