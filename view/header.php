      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start ">
          ...
          my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
            ...
            aria-label="<?php echo APP_NOME; ?>" alt="<?php echo APP_NOME; ?>" src="assets/imagens/logomarca.svg" />

          </a>

          <ul class="nav col-12 col-lg-auto my-2 justify-content-center text-center my-md-0 text-small">
            <li>
              <a href="?atividade=Home" class="nav-link text-light">
            ...
            <li>
              <a href="?atividade=Clientes" class="nav-link text-light">
            ...
            <li>
              <a href="?atividade=Servicos" class="nav-link text-light">
