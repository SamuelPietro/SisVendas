<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a href="<?php echo URL; ?>servicos/excluir/?id=<?php echo filter_input(INPUT_GET, 'id', FILTER_DEFAULT); ?>&confirmacao=ok">
    ...
    <?php if (filter_input(INPUT_GET, 'confirmacao', FILTER_DEFAULT) == "ok") {
        ...
        if ($this->model->delete($id) > 0) {
            ...
            <p>Aêêê! O serviço <b>' . $id . '</b> foi excluido com sucesso!</p>
          </div>';
        } else {
            echo '<div class="alert alert-danger  mt-4" role="alert">
            <h4 class="alert-heading">Algo errado!</h4>
            <p>Opa! Infelizmente não conseguimos excluir este serviço ' . $id . ' no banco de dados.</p>
            <hr>
